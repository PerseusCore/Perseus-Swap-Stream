...
import UpgradeDai from './../superfluidFunctions/upgradeDai';
import DowngradeDai from './../superfluidFunctions/downgradeDai';
...
const SuperfluidStream = () => {
  ...
  return (
    <div>
     ...
     <div className="sfb__heather">
       <h1 className="gradient__text">Stream DAI</h1>
     </div>
     <div>
     <CardGroup>
       <Card>
